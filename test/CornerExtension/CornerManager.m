...
@implementation UIView (ViewCornerRounder)
...
- (UIImage *)dr_drawRectWithRoundedCornerRadius:(CGFloat)radius
                                ...
                                backgroundColor:(UIColor *)backgroundColor
                                   borderCorlor:(UIColor *)borderColor {
    CGSize sizeToFit = CGSizeMake([CornerManager pixel:self.bounds.size.width], self.bounds.size.height);
